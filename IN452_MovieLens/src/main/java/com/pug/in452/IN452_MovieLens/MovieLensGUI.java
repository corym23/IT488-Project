    ...
    private void setupActionListeners() {
        ...
        connectButton.addActionListener(e -> {
            try {
                ...
                MovieLensDB db = MovieLensDB.getInstance(dbServer.getText(), dbUsername.getText(), dbPassword.getText());
        ...
        titlesButton.addActionListener(e -> {
            if (checkConnection()) {
                ...
                for (String t : titles) sb.append(t).append('\n');
        ...
        topRatedButton.addActionListener(e -> {
            if (checkConnection()) {
                ...
                StringBuilder sb = new StringBuilder();
                for (MovieRating r : top) sb.append(r.getTitle()).append(" - ").append(r.getRating()).append('\n');
        ...
        popGenresButton.addActionListener(e -> {
            if (checkConnection()) {
                ...
                StringBuilder sb = new StringBuilder();
                for (GenreCount g : popGenres) sb.append(g.getGenre()).append(" - ").append(g.getCount()).append('\n');
        ...
        popTagsButton.addActionListener(e -> {
            if (checkConnection()) {
                ...
                StringBuilder sb = new StringBuilder();
                for (TagCount t : popTags) sb.append(t.getTag()).append(" - ").append(t.getCount()).append('\n');
